...
# Inherit some common buffer stuff.
$(call inherit-product, vendor/buffer/config/common_full_phone.mk)

# Enhanced NFC
$(call inherit-product, vendor/buffer/config/nfc_enhanced.mk)
...
PRODUCT_NAME := buffer_hammerhead
